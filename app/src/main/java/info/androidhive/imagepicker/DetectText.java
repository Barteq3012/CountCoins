...
public class DetectText extends AppCompatActivity {
    ...
    private void launchCameraIntent() {
        Intent intent = new Intent(DetectText.this, ImagePickerActivity.class);
    ...
    private void detectTextFromImage() {
        ...
        firebaseVisionTextDetector.detectInImage(firebaseVisionImage).addOnSuccessListener(new OnSuccessListener<FirebaseVisionText>() {
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(DetectText.this, "Error: " + e.getMessage(), Toast.LENGTH_SHORT).show();
    ...
    private void displayTextFromImage(FirebaseVisionText firebaseVisionText) {
        ...
        if (blockList.size() == 0){
            Toast.makeText(DetectText.this, "No Text Found in image", Toast.LENGTH_SHORT).show();
        } else {
