...
import info.androidhive.imagepicker.ui.main.SectionsPagerAdapter;

public class CountCoins extends AppCompatActivity {
    private static final String TAG = CountCoins.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.count_coins);
    ...
    private void launchCameraIntent() {
        Intent intent = new Intent(CountCoins.this, ImagePickerActivity.class);
    ...
    private void detectTextFromImage() {
        ...
        firebaseVisionTextDetector.detectInImage(firebaseVisionImage).addOnSuccessListener(new OnSuccessListener<FirebaseVisionText>() {
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(CountCoins.this, "Error: " + e.getMessage(), Toast.LENGTH_SHORT).show();
    ...
    private void displayTextFromImage(FirebaseVisionText firebaseVisionText) {
        ...
        if (blockList.size() == 0){
            Toast.makeText(CountCoins.this, "No Text Found in image", Toast.LENGTH_SHORT).show();
        } else {
    ...
    private void showSettingsDialog() {
        AlertDialog.Builder builder = new AlertDialog.Builder(CountCoins.this);
